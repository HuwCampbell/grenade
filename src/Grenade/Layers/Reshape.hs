...
specReshape3D2D inp (rows, cols) = specReshape inp (rows, cols, 0)

specReshape3D1D :: (Integer, Integer, Integer) -> Integer -> SpecNet
specReshape3D1D inp rows = specReshape inp (rows, 0, 0)
...
specReshape1D3D rows = specReshape (rows, 0, 0)

specReshape1D2D :: Integer -> (Integer, Integer) -> SpecNet
specReshape1D2D rowsI (rowsO, colsO) = specReshape (rowsI, 0, 0) (rowsO, colsO, 0)
