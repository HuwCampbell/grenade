...
im2colFit :: [(Int,Int)] -> Int -> Int -> Matrix F -> Matrix F
...
col2imfit :: [(Int,Int)] -> Int -> Int -> Int -> Int -> Matrix F -> Matrix F
...
poolForward :: Int -> Int -> Int -> Int -> Int -> Int -> Matrix F -> Matrix F
poolForward nrows ncols srows scols outputRows outputCols m =
  let starts = fittingStarts (rows m) nrows srows (cols m) ncols scols
  in  poolForwardFit starts nrows ncols outputRows outputCols m

poolForwardList :: Functor f => Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> f (Matrix F) -> f (Matrix F)
...
poolForwardFit :: [(Int,Int)] -> Int -> Int -> Int -> Int -> Matrix F -> Matrix F
...
poolBackward :: Int -> Int -> Int -> Int -> Matrix F -> Matrix F -> Matrix F
...
poolBackwardList :: Functor f => Int -> Int -> Int -> Int -> Int -> Int -> f (Matrix F, Matrix F) -> f (Matrix F)
...
poolBackwardFit :: [(Int,Int)] -> Int -> Int -> Matrix F -> Matrix F -> Matrix F
